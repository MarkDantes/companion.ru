...
<section class="d-flex flex-column flex-grow-0 align-self-start flex-nowrap py-5 mt-5" style="--bs-body-bg: #f7f7fc;">
    <div class="container" style="box-shadow: 5px 8px 16px rgba(17,17,17,0.04);">
        <div class="row"
            ...
            <div class="col d-flex d-md-flex justify-content-center align-items-center m-auto justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center justify-content-lg-center justify-content-xl-center justify-content-xxl-center"
                 style="height: 455px;">
                <form class="d-flex flex-column align-items-end"
                      style="height: 404px;margin-left: 0px;margin-bottom: 35px;border-right-color: #ffffff;border-left-color: #ffffff;font-family: Poppins, sans-serif;font-size: 18px;margin-top: 15px;">
                    <div class="input-group justify-content-center align-items-center align-content-center"
                        ...
                        <button class="btn btn-primary" type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"
                                 fill="none" style="width: 24px;height: 24px;color: #A0A3BD;margin-right: -6px;">
                    ...
                    <div class="input-group justify-content-center align-items-center align-content-center"
                         style="--bs-primary: #ffffff;--bs-primary-rgb: 255,255,255;width: 325px;height: 57px;margin-top: 30px;margin-bottom: 0px;"><span
                                ...
                                style="background: #ffffff;border-top-color: #14142b;border-bottom-color: #14142b;border-left-color: #14142b;padding-top: 11.6px;height: 46.8px;width: 83px;"><svg
                                    ...
                                    viewBox="0 0 16 16" class="bi bi-plus-circle d-xxl-flex"
    ...
    <section>
        <div class="row">
            <div class="col d-grid justify-content-center align-items-center align-content-center">
