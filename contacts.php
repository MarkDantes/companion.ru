...
<?php include("header.php"); ?>
    ...
    <section class="py-5 mt-5" style="--bs-body-bg: #fff;">
        <div class="container py-5" style="font-family: Poppins, sans-serif;--bs-primary: #5f2eea;--bs-primary-rgb: 95,46,234;">
            <div class="row mb-5">
            ...
            <div class="row d-flex justify-content-center" style="border-radius: 32px;box-shadow: 0px 8px 16px rgba(17,17,17,0.04);">
                    ...
                    <div class="card-group">
                        <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/people/Saly-1.png">
                            <div class="card-body">
                                ...
                                <p class="lead card-text"><br>Проложите свой маршрут и мы постараемся подобрать вам попутчика.<br><br></p><a class="btn btn-primary" role="button" href="index.php" style="background: #5f2eea;">Найти</a>
                            </div>
                        </div>
                        <div class="card"><img class="card-img-top w-100 d-block" src="assets/img/people/Saly-43.png">
                            <div class="card-body">
                                <h3 class="card-title">Водитель</h3>
                                <p class="lead card-text"><br>Предложите поездку и, возможно, кому-то окажется с вами по пути.<br><br></p><a class="btn btn-primary" role="button" href="create.php" style="background: #5f2eea;">Создать</a>
                            </div>
                        </div>
                    </div>
                </div>
