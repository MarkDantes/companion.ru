                    ...
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center" style="border-color: #5f2eea;font-family: Poppins, sans-serif;box-shadow: 0px 8px 16px rgba(17,17,17,0.04);border-radius: 32px;font-size: 18px;">
                            ...
                            <form action="/signup.php" method="post">
                                ...
                                <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" type="submit" name="do_signup" style="background: #5f2eea;font-family: Poppins, sans-serif;margin-top: 30px;width: 319px;height: 64px;border-radius: 16px;">Регистрация</button></div>
